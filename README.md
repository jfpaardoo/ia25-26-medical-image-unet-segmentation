...
- **Métricas:** Se usa DICE como métrica principal para validación y evaluación, simplificando el modelo para asegurar la precisión en los apartados requeridos.
